...
ActiveRecord::Schema[7.1].define(version: 2026_07_17_000100) do
  ...
  create_table "attachments", id: :serial, force: :cascade do |t|
    ...
    t.string "extension"
    t.jsonb "meta", default: {}
    t.index "account_id, ((meta ->> 'sticker_pack'::text))", name: "index_attachments_on_account_sticker_pack", where: "((meta ->> 'sticker_type'::text) = 'custom'::text)"
    t.index "account_id, file_type, ((meta ->> 'sticker_type'::text))", name: "index_attachments_on_account_file_type_sticker_type", where: "((meta ->> 'sticker_type'::text) IS NOT NULL)"
    t.index ["account_id", "created_at"], name: "index_attachments_on_account_created_at_stickers", where: "((meta ->> 'sticker_type'::text) = 'custom'::text)"
  ...
  create_table "payment_links", force: :cascade do |t|
    ...
    t.index ["order_nsu"], name: "index_payment_links_on_order_nsu", unique: true
    t.index ["status"], name: "index_payment_links_on_status"
    t.index ["user_id"], name: "index_payment_links_on_user_id"
  end

  create_table "payment_presets", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.string "name", null: false
    t.integer "amount_cents", null: false
  ...
  create_table "webhooks", force: :cascade do |t|
    ...
    t.boolean "include_access_token", default: false, null: false
    t.string "name"
    t.string "secret"
  ...
  create_table "whatsapp_interactive_templates", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.text "static_url"
    t.jsonb "quick_replies", default: [], null: false
