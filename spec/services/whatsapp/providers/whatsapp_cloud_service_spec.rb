...
describe Whatsapp::Providers::WhatsappCloudService do
  ...
  describe '#send_message' do
    context 'when called' do
      ...
      it 'uploads the sticker to /media and sends it by media id' do
        ...
        stub_request(:post, 'https://graph.facebook.com/v22.0/123456789/media')
          .to_return(status: 200, body: { id: 'sticker-media-id' }.to_json, headers: response_headers)
        stub_request(:post, 'https://graph.facebook.com/v22.0/123456789/messages')
        ...
        expect(WebMock).to have_requested(:post, 'https://graph.facebook.com/v22.0/123456789/media')
        expect(WebMock).to(have_requested(:post, 'https://graph.facebook.com/v22.0/123456789/messages').with do |req|
          body = JSON.parse(req.body)
          body['type'] == 'sticker' && body['sticker']['id'] == 'sticker-media-id'
        end)
      end
  ...
  describe '#send_template' do
    ...
    context 'when called' do
      ...
      it 'sends named templates with image headers using the current Cloud API payload' do
              ...
              parameters: [
                {
                  ...
                  text: "📄 Processo 9532027-01.2026.4.01.3315\n15 novas movimentações encontradas"
                }
              ]
            }
          ]
          ...
          .to_return(
            ...
            body: {
              ...
              paging: {
                ...
                next: 'https://graph.facebook.com/v22.0/123456789/message_templates?after=cursor-1&access_token=test_key'
              }
            }.to_json
          )
        stub_request(:get, 'https://graph.facebook.com/v22.0/123456789/message_templates?after=cursor-1')
          .with(headers: request_headers)
          .to_return(
            status: 200,
            headers: response_headers,
            body: {
              ...
              paging: {
                ...
                next: 'https://graph.facebook.com/v22.0/123456789/message_templates?after=cursor-2&access_token=test_key'
              }
            }.to_json
          )
        stub_request(:get, 'https://graph.facebook.com/v22.0/123456789/message_templates?after=cursor-2')
          .with(headers: request_headers)
          .to_return(
            status: 200,
            headers: response_headers,
