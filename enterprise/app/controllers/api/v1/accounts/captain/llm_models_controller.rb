...
# lists solely through Chatwit::LlmProxy.operational_models — never a local
# catalog, never a direct LiteLLM call. Central unavailable/empty degrades to
# { models: [], source: "unavailable", operational: false } with a stable 200
# and never leaks the internal key or URL.
